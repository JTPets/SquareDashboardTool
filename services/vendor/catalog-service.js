 ...
 *
 * Features:
 * - CSV/XLSX parsing with auto-detection of column mappings
 * - UPC/SKU matching to existing catalog items
 * - Price comparison and margin calculation
 * - Batch import management (archive, delete, regenerate reports)
 *
