...
// Diagnostics functions extracted to square-diagnostics.js (Phase 3a)
const { fixLocationMismatches, fixInventoryAlerts, enableItemAtAllLocations } = require('./square-diagnostics');

// Custom attribute functions extracted to square-custom-attributes.js (Phase 3b)
const {
...
// Pricing functions extracted to square-pricing.js (Phase 3c)
