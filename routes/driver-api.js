 ...
 */
router.post('/delivery/route/:id/share', requireAuth, requireMerchant, validators.shareRoute, async (req, res) => {
    try {
 ...
 */
router.get('/delivery/route/:id/token', requireAuth, requireMerchant, validators.getRouteToken, async (req, res) => {
    try {
        const merchantId = req.merchantContext.id;
        const routeId = req.params.id;
 ...
 */
router.delete('/delivery/route/:id/token', requireAuth, requireMerchant, validators.revokeRouteToken, async (req, res) => {
    try {
        const merchantId = req.merchantContext.id;
        const routeId = req.params.id;
 ...
 */
router.get('/driver/:token', validators.getDriverRoute, async (req, res) => {
    try {
 ...
 */
router.post('/driver/:token/orders/:orderId/complete', validators.completeOrder, async (req, res) => {
    try {
 ...
 */
router.post('/driver/:token/orders/:orderId/skip', validators.skipOrder, async (req, res) => {
    try {
 ...
 */
router.post('/driver/:token/orders/:orderId/pod', podUpload.single('photo'), validateUploadedImage('photo'), validators.uploadPod, async (req, res) => {
    try {
        if (!req.file) {
 ...
 */
router.post('/driver/:token/finish', validators.finishRoute, async (req, res) => {
    try {
