 ...
 */
router.get('/expiry-discounts/tiers', requireAuth, requireMerchant, asyncHandler(async (req, res) => {
    const merchantId = req.merchantContext.id;
 ...
 */
router.get('/expiry-discounts/variations', requireAuth, requireMerchant, validators.getVariations, asyncHandler(async (req, res) => {
 ...
 */
router.post('/expiry-discounts/evaluate', requireAuth, requireMerchant, validators.evaluate, asyncHandler(async (req, res) => {
 ...
 */
router.get('/expiry-discounts/audit-log', requireAuth, requireMerchant, validators.getAuditLog, asyncHandler(async (req, res) => {
 ...
 */
router.get('/expiry-discounts/settings', requireAuth, requireMerchant, asyncHandler(async (req, res) => {
    const merchantId = req.merchantContext.id;
    const result = await db.query(`
 ...
 */
router.get('/expiry-discounts/validate', requireAuth, requireMerchant, asyncHandler(async (req, res) => {
    const merchantId = req.merchantContext.id;
 ...
 */
router.post('/expiry-discounts/validate-and-fix', requireAuth, requireMerchant, requireWriteAccess, asyncHandler(async (req, res) => {
    const merchantId = req.merchantContext.id;
    const result = await expiryDiscount.validateExpiryDiscounts({
        merchantId,
        fix: true
