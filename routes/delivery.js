 ...
 */
router.patch('/orders/:id', requireAuth, requireMerchant, validators.updateOrder, async (req, res) => {
    try {
        const merchantId = req.merchantContext.id;
        const updates = {};
 ...
 */
router.delete('/orders/:id', requireAuth, requireMerchant, validators.deleteOrder, async (req, res) => {
    try {
        const merchantId = req.merchantContext.id;
 ...
 */
router.post('/orders/:id/skip', requireAuth, requireMerchant, validators.skipOrder, async (req, res) => {
    try {
        const merchantId = req.merchantContext.id;
 ...
 */
router.post('/orders/:id/complete', requireAuth, requireMerchant, validators.completeOrder, async (req, res) => {
    try {
        const merchantId = req.merchantContext.id;
        const order = await deliveryApi.getOrderById(merchantId, req.params.id);
 ...
 */
router.get('/orders/:id/customer', requireAuth, requireMerchant, validators.getOrder, async (req, res) => {
    try {
        const merchantId = req.merchantContext.id;
        const order = await deliveryApi.getOrderById(merchantId, req.params.id);
 ...
 */
router.patch('/orders/:id/customer-note', deliveryRateLimit, requireAuth, requireMerchant, validators.updateCustomerNote, async (req, res) => {
    try {
        const merchantId = req.merchantContext.id;
        const { note } = req.body;
        const order = await deliveryApi.getOrderById(merchantId, req.params.id);
 ...
 */
router.patch('/orders/:id/notes', deliveryRateLimit, requireAuth, requireMerchant, validators.updateOrderNotes, async (req, res) => {
    try {
        const merchantId = req.merchantContext.id;
 ...
 */
router.get('/orders/:id/customer-stats', requireAuth, requireMerchant, validators.getOrder, async (req, res) => {
    try {
        const merchantId = req.merchantContext.id;
 ...
 */
router.post('/orders/:id/pod', deliveryRateLimit, requireAuth, requireMerchant, podUpload.single('photo'), validateUploadedImage('photo'), validators.uploadPod, async (req, res) => {
    try {
        const merchantId = req.merchantContext.id;
 ...
 */
router.get('/pod/:id', requireAuth, requireMerchant, validators.getPod, async (req, res) => {
    try {
        const merchantId = req.merchantContext.id;
 ...
 */
router.post('/route/generate', deliveryStrictRateLimit, requireAuth, requireMerchant, validators.generateRoute, async (req, res) => {
    try {
        const merchantId = req.merchantContext.id;
 ...
 */
router.get('/route/active', requireAuth, requireMerchant, validators.getActiveRoute, async (req, res) => {
    try {
        const merchantId = req.merchantContext.id;
 ...
 */
router.get('/route/:id', requireAuth, requireMerchant, validators.getRoute, async (req, res) => {
    try {
        const merchantId = req.merchantContext.id;
 ...
 */
router.post('/route/finish', requireAuth, requireMerchant, validators.finishRoute, async (req, res) => {
    try {
        const merchantId = req.merchantContext.id;
 ...
 */
router.post('/geocode', deliveryStrictRateLimit, requireAuth, requireMerchant, validators.geocode, async (req, res) => {
    try {
        const merchantId = req.merchantContext.id;
 ...
 */
router.get('/audit', requireAuth, requireMerchant, validators.getAudit, async (req, res) => {
    try {
        const merchantId = req.merchantContext.id;
 ...
 */
router.post('/sync', deliveryStrictRateLimit, requireAuth, requireMerchant, validators.syncOrders, async (req, res) => {
    try {
        const merchantId = req.merchantContext.id;
