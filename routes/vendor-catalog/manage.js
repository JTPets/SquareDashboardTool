...
router.post('/vendor-catalog/push-price-changes', requireAuth, requireMerchant, requireWriteAccess, validators.pushPriceChanges, asyncHandler(async (req, res) => {
...
router.post('/vendor-catalog/confirm-links', requireAuth, requireMerchant, requireWriteAccess, validators.confirmLinks, asyncHandler(async (req, res) => {
...
router.post('/vendor-catalog/deduplicate', requireAuth, requireMerchant, requireWriteAccess, validators.deduplicate, asyncHandler(async (req, res) => {
    const merchantId = req.merchantContext.id;
...
router.post('/vendor-catalog/create-items', requireAuth, requireMerchant, requireWriteAccess, validators.createItems, asyncHandler(async (req, res) => {
...
router.post('/vendor-catalog/batches/:batchId/archive', requireAuth, requireMerchant, requireWriteAccess, validators.batchAction, asyncHandler(async (req, res) => {
...
router.post('/vendor-catalog/batches/:batchId/unarchive', requireAuth, requireMerchant, requireWriteAccess, validators.batchAction, asyncHandler(async (req, res) => {
    const { batchId } = req.params;
    if (!batchId) return sendError(res, 'Batch ID is required', 400);
...
router.delete('/vendor-catalog/batches/:batchId', requireAuth, requireMerchant, requireWriteAccess, validators.batchAction, asyncHandler(async (req, res) => {
    const { batchId } = req.params;
    if (!batchId) return sendError(res, 'Batch ID is required', 400);
